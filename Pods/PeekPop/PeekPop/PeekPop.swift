...
/// PeekPop class
@objc open class PeekPop: NSObject {
    ...
    @objc public func registerForPreviewingWithDelegate(_ delegate: PeekPopPreviewingDelegate, sourceView: UIView) -> PreviewingContext {
...
@objc public protocol PeekPopPreviewingDelegate: class {
