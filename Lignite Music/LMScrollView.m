...
- (void)layoutSubviews {
	...
	contentRect = CGRectMake(0, 0, self.adaptForWidth ? (contentRect.size.width+30) : WINDOW_FRAME.size.width, self.adaptForWidth ? self.frame.size.height : (contentRect.size.height+20));
