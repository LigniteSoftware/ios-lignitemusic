 ...
 */
@property YIInnerShadowView *controlBarInnerShadowView;
...
- (void)layoutSubviews {
	if(!self.didLayoutConstraints){
		...
		self.controlBarInnerShadowView = [YIInnerShadowView newAutoLayoutView];
		self.controlBarInnerShadowView.shadowMask = YIInnerShadowMaskAll;
		[self.controlBar addSubview:self.controlBarInnerShadowView];
		
		[self.controlBarInnerShadowView autoPinEdgesToSuperviewEdges];
