...
/**
 The root view for loading in the control bar and info view.
 */
...
- (void)rootViewWillTransitionToSize:(CGSize)size withTransitionCoordinator:(id<UIViewControllerTransitionCoordinator>)coordinator {
	[coordinator animateAlongsideTransition:^(id<UIViewControllerTransitionCoordinatorContext>  _Nonnull context) {
		self.collectionInfoView.textAlignment = (size.width > size.height) ? NSTextAlignmentLeft : NSTextAlignmentCenter;
...
//        [self.tableView reloadData];
	...
	collectionInfoView.textAlignment = self.layoutManager.isLandscape ? NSTextAlignmentLeft : NSTextAlignmentCenter;
	[rootView addSubview:collectionInfoView];
	
	[collectionInfoView autoAlignAxisToSuperviewAxis:ALAxisVertical];
	[collectionInfoView autoMatchDimension:ALDimensionWidth toDimension:ALDimensionWidth ofView:rootView withMultiplier:(9.0/10.0)];
...
//	collectionInfoView.layer.shadowOpacity = 0.10f;
	...
	self.collectionInfoView = collectionInfoView;
	NSLog(@"Shit is %p", self.collectionInfoView);
